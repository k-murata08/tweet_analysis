...
VALID_USER_MAX_CREATED_AT = 2017 # 何年までに登録されたユーザで絞り込むか
# ----------------------------------

# --------- 共通フォロー分析-------------------------
MIN_COUNT_LIMIT = 5         # CSVに書き出すのはCountが最低いくつ以上のユーザか
...
# --- ツイートテキストファイル作成用-----
TWEETS_COUNT_FOR_MAKE_TEXT = 200
# ---------------------------------------
